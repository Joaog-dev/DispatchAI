...
namespace DispatchAI.Api.Migrations
{
    /// <inheritdoc />
    public partial class CreateLogistics : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Code = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
                    OriginAddress = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    OriginLat = table.Column<double>(type: "REAL", nullable: false),
                    OriginLng = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Geometry = table.Column<string>(type: "TEXT", maxLength: 8000, nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
